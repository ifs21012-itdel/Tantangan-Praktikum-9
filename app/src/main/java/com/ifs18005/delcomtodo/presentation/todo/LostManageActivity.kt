...
import com.ifs18005.delcomtodo.databinding.ActivityTodoManageBinding
import com.ifs18005.delcomtodo.helper.Utils.Companion.observeOnce
import com.ifs18005.delcomtodo.helper.getImageUri
import com.ifs18005.delcomtodo.helper.reduceFileImage
import com.ifs18005.delcomtodo.helper.uriToFile
...
class LostManageActivity : AppCompatActivity() {
    ...
    binding.apply {
      ...
      btnTodoManageSave.setOnClickListener {
        ...
        if (title.isEmpty() || description.isEmpty()) {
          AlertDialog.Builder(this@LostManageActivity).apply {
            setTitle("Oh No!")
  ...
  private fun manageEditTodo(todo: DelcomTodo) {
    binding.apply {
      ...
      if (todo.cover != null) {
        Glide.with(this@LostManageActivity)
          .load(todo.cover)
