...
import com.ifs18005.delcomtodo.databinding.ActivityTodoFavoriteBinding
import com.ifs18005.delcomtodo.helper.Utils.Companion.entitiesToResponses
...
class LostFavoriteActivity : AppCompatActivity() {
  ...
  private fun setupAction() {
    binding.appbarTodoFavorite.setNavigationOnClickListener {
      ...
      resultIntent.putExtra(LostDetailActivity.KEY_IS_CHANGED, true)
      setResult(LostDetailActivity.RESULT_CODE, resultIntent)
  ...
  private fun loadTodosToLayout(todos: List<DelcomTodoEntity>?) {
    ...
    if (todos.isNullOrEmpty()) {
      ...
      adapter.setOnItemClickCallback(
        object : LostAdapter.OnItemClickCallback {
